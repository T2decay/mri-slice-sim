...
> Earlier review-gate notes below are historical.

> September 8: Active scope is now Spine only: cervical, thoracic, lumbar,
> and sacrum (slides 29–40). Body and other-region review is deferred.
> Focused review: `review/expansion/spine/index.html`, generated by
> `pipeline/.venv/bin/python -B scripts/stage-spine.py`.
> Twelve slides / 31 source images. Missing axial views on 29,32,34,35,37;
> tall sagittal image on 32; middle-image plane on 38 needs confirmation.
> No substitutions, content assembly, or publishing authorized by this review.
